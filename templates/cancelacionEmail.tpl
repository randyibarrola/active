                                    ...
                                    <table dir="ltr" style="font-size:14px; width:100%">
                                        <tr>
                                            <td style="padding-bottom:5px;">
                                                <strong>{#Lamentamos_comunicarte_que_tu_reserva_con_localizador#} {$reserva->localizador} {#ha_sido_cancelada#}.</strong>
                                            </td>
                                        </tr>
                                        {if $reserva->motivoCancelacion}
                                            <tr>
                                                <td style="padding-bottom:5px;">
                                                    <strong>{#motivo_de_cancelacion#}:</strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <th style="text-align:left">
                                                <a href="#" style="text-decoration: none; color: #026DC5; font-size: 16px; font-weight: 500;">
                                                            	<span style="color:#026DC5">
                                                                	{#tu_reserva#} {#en#} {$reserva->hotel->nombre}
                                                                </span>
                                                </a>
                                            </th>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <p style="margin-top:10px; margin-bottom:0">
                                                    {$reserva->hotel->direccion->descripcion}
                                                </p>
                                                <p style="margin-bottom:0">
                                                    {#telefono#}: {$reserva->hotel->empresa->telefonoReservas}
                                                </p>
                                                <p style="">
                                                    {#latitud#}: {$reserva->hotel->direccion->lat}, {#longitud#}: {$reserva->hotel->direccion->lon}
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p style="margin-bottom:1px">
                                                    <strong>{$noches} {#noche_s#} {#en#} {$apartamento->nombre} {$reserva->moneda->simbolo}{$apartamento->precioUnitario|number_format:2:',':' '}</strong>
                                                </p>
                                                {if $apartamento->condicion}
                                                    <p style="margin-bottom:1px">
                                                        <strong>{$apartamento->condicion}</strong>
                                                    </p>
                                                {/if}
                                                {if $apartamento->pension}
                                                    <p style="margin-bottom:1px">
                                                        <strong>{$apartamento->pension}</strong>
                                                    </p>
                                                {/if}
                                                {if $reserva->cart}
                                                    <p style="margin-bottom:1px">
