            ...
            <tr>
                <td DIR="LTR" valign="top" style="padding:10px;">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td align="left" valign="top" style="font-size:14px;">{#lo_lamentamos#} <span="font-weight:bold"> {$usuario->nombre} {$usuario->apellido}!</span></td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" style="padding-top:10px; font-size:16px; font-weight:bold;">{#Tu_reserva_con_localizador#}<span style="font-size:20px; color:#ed107f;"> [{$reserva->localizador}] </span> {#ha_sido_cancelada#}.</td>
                        </tr>
                        {if $reserva->motivoCancelacion}
                        <table width="100%" style="background-color:#fffef0;padding:10px;margin-top:10px;">
                            <tr>
                                <td align="left" valign="top" style="padding-top:10px; font-size:12px;">{#motivo_de_cancelacion#}:</td>
                            </tr>
                            <tr>
