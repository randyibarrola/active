...
<head><META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">
	...
	.ExternalClass img[class^=Emoji] { width: 10px !important; height: 10px !important; display: inline !important; }
        ...
        a, a span, a.span:hover {color:#4E4E4E;background-color:none;border:0px;}
        a.btn, a.btn span  {color:#FFFFFF;background-color:none;border:0px;}
        .footer a, .footer a span  {color:#4E4E4E;background-color:none;border:0px;}
        span.yshortcuts { color:#4E4E4E; background-color:none; border:0px;}
        span.yshortcuts:hover,
        span.yshortcuts:active,
        span.yshortcuts:focus {color:#4E4E4E; background-color:none; border:0px;}
        ...
        @media only screen and (max-device-width: 568px) {
            a.tel, a.tel:link, a.tel:visited, a.tel:hover, a.tel:active {text-decoration:underline !important; background-color:none; border:none;}
        }

            /* Link Hover Call-to-Action */
        ...
        table{-webkit-text-size-adjust:none; -ms-text-size-adjust:none;}
        span{-webkit-text-size-adjust:none; -ms-text-size-adjust:none;}
        div{-webkit-text-size-adjust:none; -ms-text-size-adjust:none;}

            /* Direction in Email */
        table td[DIR="rtl"] {direction:RTL !important; unicode-bidi:embed !important;}
        span[DIR="rtl"] {direction:RTL !important; unicode-bidi:embed !important;}
        div[DIR="rtl"] {direction:RTL !important; unicode-bidi:embed !important;}
        ...
        @media only screen and (min-device-width: 768px) and (max-device-width: 1024px) {
            table[class="tablewidth"], td[class="cellwidth"], img[class="imgwidth"] { width: 768px !important;}
            table[class="hide"], img[class="hide"], td[class="hide"], div[class="hide"], span[class="hide"] { display: none !important; }
        }

        .hdrLogoImg {display:block !important; width:300px; height:60px;}
        .hdrLogoImgPrint {display:none; display:none !important;width:0px; height:0px;font-size:0;}

        @media print {

            .ContainerGrey {background-color:#FFFFFF;}
            .hdrTBL {background-color:#FFFFFF;}
            .hdrLogoTD {background-color:#FFFFFF;}
            .hdrLogoImg {display:none; display:none !important; width:0px; height:0px;font-size:0;}
            .hdrLogoImgPrint {display:block !important; width:218px; height:30px;}
            .hdrPhoneTD div {color:#000000;}
            .hdrPhoneTD {color:#000000;}
            .navTD,.socialMobile,.footerbar,.signup,.hdrTUVTD img {}
        }
                                ...
                                <tr>
                                    ...
                                    <td class="hdrPhoneTD" valign="middle">
                                        <div style="font-size:12px; text-align:right;color:#666; line-height:1.25em;">
                                            {#puedes_contactar_con_nosotros_en#}:
                                        </div>
                                        <div style="font-size:12px; text-align:right;color:#666; line-height:1.25em;">
                    ...
                    <td DIR="LTR" valign="top" style="padding:10px;">
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <td align="left" valign="top" style="padding-top:10px;">
                                {#se_ha_hecho_una_reserva_por_valor_de#} <b> {$reserva->moneda->simbolo}{$reserva->alojamiento[0]->precioUnitario|number_format:2:',':' '}</b>.
                            </td>
                            {if $reserva->alojamiento[0]->porcientoInicial && $reserva->alojamiento[0]->importeInicial}
                            <tr>
                                <td align="left" valign="top" style="padding-top:10px;">
                                    {#el_cliente_ha_pagado_por#} <b>{$reserva->alojamiento[0]->porcientoInicial}%({$reserva->moneda->simbolo}{$reserva->alojamiento[0]->importeInicial|number_format:2:',':' '})</b> {#de_la_reserva_en_concepto_de_comisiones#}, {#el_resto_lo_pagara_segun_las_condiciones#} {$hotel->nombre}.
                                </td>
                            </tr>
                            {/if}
                            <table style="background-color:#ed107f;padding:10px;margin-top:10px; width:100%;">
                                <tr >
                                    <td align="center" valign="top" style="font-size:14px;font-weight:bold; color:#FFF;">
                                        {#importe_a_cobrar_por#} {$hotel->nombre} <b> {$reserva->moneda->simbolo}
                                            {math equation="x - y" x=$reserva->alojamiento[0]->precioUnitario y=$reserva->alojamiento[0]->importeInicial format="%.2f"}</b>
                                    </td>
                                </tr>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto; align:center; width:600px; padding:0%; background-color: #FFFFFF; position:relative;border: solid 1px #CCCCCC; -webkit-border-radius:8px; -moz-border-radius:8px; border-radius:8px;">
                            <tr>
                                <td DIR="LTR" valign="middle" style="padding:0px 10px; height:30px; width:100% !important; max-width:600px; border-bottom: solid 1px #DCDCDC; -webkit-border-radius:8px; -moz-border-radius:8px; border-bottom-left-radius:0; border-bottom-right-radius:0; border-top-left-radius:8px; border-top-right-radius:8px; background-color:#F6F6F6;">
                                    <table style="width:100% !important;" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td DIR="LTR" style="font-size:18px; font-weight:bold; color:#4E4E4E; text-align:left;">{#Datos_del_cliente#}</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td DIR="LTR" valign="top" style="padding:10px;">
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td align="left" valign="top" >{#nombre#}: <span style="color:#333;font-weight:bold;">{$usuario['nombre']} {$usuario['apellido']}</span>
                                            </td>
                                        </tr>
                                        {if $reserva->usuario->pais}
                                        <tr>
                                            <td align="left" valign="top">{#pais#}:<span style="color:#333; font-weight:bold;"> {$reserva->usuario->pais->nombre}</span>
                                            </td>
                                        </tr>
                                        {/if}
                                        <tr>
                                            <td align="left" valign="top">{#telefono#}: <span style="color:#333;font-weight:bold;">{$usuario['telefono']}</span>
                                            </td>
                                        <tr>
                                            </td>
                                            <td align="left" valign="top">{#email#}: <span style="color:#333;font-weight:bold;"><a href="mailto:{$usuario['email']}" class="email" style="text-decoration:none;"><span dir="ltr" style="color:#666;">{$usuario['email']}</span></a></span>
                                            </td>

                                            <td align="left" valign="top" width="150">
                                                <table cellspacing="0" cellpadding="0" border="0">
                                                    <tr>
                                                        <td align="left" valign="top" style="font-weight:bold;"><a href="http://admin.madridactive.com/reserva?login_code=7c7fd0-1334802-c34b-222d2&rloc=1D335">{#ver_detalles_de_la_reserva#}</a></td>
                                                    </tr>
                                                    <!--  //-->
                                                </table>
                                            </td>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto; align:center; width:600px; padding:0%; background-color: #FFFFFF; position:relative;border: solid 1px #CCCCCC; -webkit-border-radius:8px; -moz-border-radius:8px; border-radius:8px;">
                            ...
                            <tr>
                                <td DIR="LTR" valign="top" style="padding:10px;">
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td align="left" valign="top" style="font-weight:bold"><span>{$reserva->alojamiento[0]->nombre}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" valign="top" style="font-weight:bold">{$noches} {#noche_s#}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" valign="top">{#entrada#}:<span style="color:#333; font-weight:bold;"> {$entrada|date_format:"%e/%m/%Y"}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            </td>
                                            <td align="left" valign="top">{#salida#}: <span style="color:#333;font-weight:bold;"> {$salida|date_format:"%e/%m/%Y"}</span>
                                            </td>
                                        </tr>
                                        {if $reserva->alojamiento[0]->condicion}
                                        <tr>
                                            </td>
                                            <td align="left" valign="top" style="color:#333;font-weight:bold;"> {$reserva->alojamiento[0]->condicion}
                                            </td>
                                        </tr>
                                        {/if}
                                    </table>
