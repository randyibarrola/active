...
{block name="script" append}
    ...
    {literal}
        <!-- Google Code for Reserva Conversion Page -->
        <script type="text/javascript">
            /* <![CDATA[ */
            var google_conversion_id = 975491781;
            var google_conversion_language = "en";
            var google_conversion_format = "2";
            var google_conversion_color = "ffffff";
            var google_conversion_label = "6gD6CIXNj1YQxaWT0QM";
        ...
        <noscript>
            <div style="display:inline;">
                <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/975491781/?value=1.00&amp;currency_code=EUR&amp;label=6gD6CIXNj1YQxaWT0QM&amp;guid=ON&amp;script=0"/>
            </div>
        </noscript>
    {/literal}
{/block}
...
{block name="main_content" append}
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-primary">¡{#gracias#}, {$usuario->nombre} {if $reserva->estado eq 'Aprobada'}{#tu_reserva_esta_confirmada#}{else}{#tu_reserva_esta_pendiente_de_aprobacion#}{/if}</h2>
            <ul class="checklist">
                <li><p>{#te_hemos_enviado_un_email_de_confirmacion_a#} {$usuario->email|truncate:7}</p></li>
                <li><p>{#hemos_informado_al#}</p></li>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6"><p>{$noches}</p></div>
                    </div>
                    <div class="row">
                    ...
                    {if $reserva->peticionesEspeciales && strlen(trim($reserva->peticionesEspeciales))}
                        <div class="row">
                            <div class="col-md-6"><strong>{#Peticiones_especiales#}:</strong></div>
                            <div class="col-md-6">{htmlentities($reserva->peticionesEspeciales)}</div>
                        </div>
                    {/if}
    ...
    <!--<div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">{#datos_de_la_empresa#}</h3>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                        <div class="col-md-3"><p><strong>{#nombre#}</strong></p></div>
                                        <div class="col-md-9">
                                            <p>{$hotel->empresa->nombreComercial}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3"><p><strong>{#direccion#}</strong></p></div>
    ...
    <div class="row" style="text-align: center;">
        <a href="{$base_url}/{$lang}/confirmacion/r_id:{$id}/print:1{$end_url}" class="btn btn-default" id="imprimirBtn" target="_blank">{#imprimir#}</a>
        <a href="javascript:void(0)" class="btn btn-danger" id="cancelarBtn">{#cancelar_reserva#}</a>
        <a href="{if $reserva->urlOrigen}{$reserva->urlOrigen}{else}{$base_url}/{$lang}/index{$end_url}{/if}" class="btn btn-success">{#finalizar#}</a>
    </div>
    </div>
    </div>
    </div>
