	...
	<div class="wrapper">
		...
		<div class="pull-right">
			...
			<a class="pull-right recuperar_reserva_modal" href="javascript:void(0)">Recuperar reserva</a>
                        <a class="pull-right inicio" href="{$base_url}/admin-login">Iniciar sesión</a>
		</div>
	</header>
	...
	<div class="content_wrapper">
            <div class="content search">
                <form class="login-form" action="{$base_url}/admin-login" method="post">
                    <h3 class="form-title">{#Busca_hoteles#}</h3>
                    <div class="form-group">
                            <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                            <label class="control-label visible-ie8 visible-ie9">Correo electrónico</label>
                            <div class="input-icon">
                                    <i class="fa fa-building-o"></i>
                                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Hotel" name="hotel"/>
                            </div>
                    </div>
