...
<div class="row-fluid clearfix ">
    <div class="col-md-12">
        <div class="main_content book-confirmation" style="margin-top: 10px;">
            <div class="book-confirmation-inner">
                <div class="row">
                    ...
                    <h2 class="text-primary">¡{#gracias#}, {$usuario->nombre} {if $reserva->estado eq 'Aprobada'}{#tu_reserva_esta_confirmada#}{else}{#tu_reserva_esta_pendiente_de_aprobacion#}{/if}</h2>
                        <ul class="checklist">
                            <li><p>{#te_hemos_enviado_un_email_de_confirmacion_a#} {$usuario->email|truncate:10}</p></li>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">{$reserva->peticionesEspeciales}</div>
                                    </div>
                                    {/if}
