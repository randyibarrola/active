                                ...
                                <div class="form-body ver-campania">
                                    ...
                                    <div class="row-fluid container-fluid">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <label class="col-md-6">{$campania->empresaDistribuidora->contactoNombre} {$campania->empresaDistribuidora->contactoApellidos}</label>
                                            <div class="delimiter"></div>
                                        </div>
                                            <div class="delimiter"></div>
                                    </div>
...
<li>c) Asimismo, se obliga a ofrecer al Usuario de Internet y Comprador, la información adecuada para la reserva, entre ella, los precios y condiciones generales aplicables.</li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 centered ">
                                                ...
                                                <a class="btn btn-default" href="{$base_url}/admin-campania-lista" >Finalizar</a>
                                                {else}
                                                    <a class="btn btn-default" href="{$base_url}/admin-contrato-lista" >Finalizar</a>
                                                {/if}
