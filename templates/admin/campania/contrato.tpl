...
{block name="script" append}
    <script type="text/javascript" src="{$template_url}/js/admin/campania-contrato.js"></script>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">Productos					
                        <small>Asistente de contrataci&oacute;n</small>
                    </h3>
                            ...
                            <!-- BEGIN FORM-->
                                ...
                                <div class="form-body form-wizard">
                                    <ul class="nav nav-pills nav-justified steps">
                                        ...
                                        {if $usuario->usuarioGrupoId ne 3}
                                        <li>
                                ...
                                <div id="bar" class="progress progress-striped" role="progressbar">
                                    ...
                                    <div id="empresaDiv">
                                        ...
                                        <div class="row">
                                            <div class="row-fluid">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control validate[required]" name="empresaDistribuidoraId">
                                                            {foreach from=$distribuidoras item=empresa}
                                                                <option pb="{$empresa->porcentajeBeneficio}" value="{$empresa->id}" {if $empresa->id eq $campania->empresaDistribuidoraId}selected{/if}>{$empresa->nombreComercial}</option>
                                                            {/foreach}
                                                        </select>    
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Tu empresa (Cliente)</label>
                                                        <input class="form-control validate[required]" id="empresaId" value="">
                                                        <select class="form-control validate[required] hidden" name="empresaId">
                                                            {foreach from=$empresas item=empresa}
                                                                <option value="{$empresa->id}" {if $empresa->id eq $campania->empresaId}selected{/if}>{$empresa->nombreComercial}</option>
                                                            {/foreach}
                                                        </select>    
                                                    </div>
                                                </div>
                                                <div class="col-md-6" id="nuevaEmpresa">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <a style="margin-top: 24px" class="btn btn-success" id="nuevaEmpresaBtn" href="javascript:void(0)">Nueva empresa</a>    
                                                        </div>
                                                    </div>
                                                    <div class="delimiter"></div>
                                                </div>
                                                        <div class="col-md-6" id="addEmpresa" style="display:none;">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            <label>Nombre comercial de la empresa</label>
                                                            <input type="text" class="form-control" name="empresa" placeholder="Nombre de la nueva empresa">    
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <a style="margin-top: 24px" class="btn btn-success disabled" id="addEmpresaBtn" href="javascript:void(0)">Registrar</a>    
                                                        </div>
                                                    </div>
                                                    <div class="delimiter"></div>
                                                </div>
                                            ...
                                            {assign var=empresa value=$empresas[0]}
                                            {if $campania->empresaId && $campania->empresaId ne $empresa->id}
                                                {foreach from=$empresas item=$e}
                                                    {if $e->id eq $campania->empresaId}{assign var=empresa value=$e}{/if}
                                                {/foreach}
                                            {/if}
                                            ...
                                            <div class="row-fluid">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="numeroFiscal" class="form-control" placeholder="N&uacute;mero Fiscal" value="{$empresa->numeroFiscal}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row-fluid">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="emailReservas" id="email" class="form-control validate[required, custom[email]]" placeholder="Email" value="{$empresa->emailReservas}">
                                                    </div>
                                                </div>
                                                <!--<div class="col-md-6">
                                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="lat" id="direccion_lat" class="form-control validate[custom[number]]" placeholder="Latitud"  value="{$empresa->direccion->lat}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Longitud</label>
                                                    <input type="text" name="lon" id="direccion_lon" class="form-control validate[custom[number]]" placeholder="Longitud" value="{$empresa->direccion->lon}">
                                                </div>
                                            </div>
                                            -->
                                    ...
                                    <!-- end empresa -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 centered">
                                                <a href="#contratoDiv" class="btn btn-success">Siguiente</a>
                                            </div>
                                        </div>
                                        </form>
                                    </div>
                                    ...
                                    <div id="contratoDiv">
                                        ...
                                        <div class="row">
                                            <div class="row-fluid">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="tipo_producto" class="form-control" name="tipo">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control validate[required]" name="nombreHotel" value="{$campania->nombreHotel}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Comisión</label>
                                                        <input type="text" class="form-control validate[required, custom[number]]" {if $usuario->usuarioGrupoId ne 3}disabled=""{/if} name="porcentajeBeneficio" value="{$campania->porcentajeBeneficio}">
                                                    </div>
                                                </div>
                                                <div class="delimiter"></div>
                                            </div>
                                            <div class="row-fluid">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control validate[required]" name="nombre" value="{$campania->nombre}{if !$edit} {date('d/m/Y')}{/if}">
                                                    </div>
                                                </div>
                                                
                                                <div class="delimiter"></div>
                                            </div>
                                            <div class="row-fluid tipo_hotel">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <label>Dominio oficial de campa&ntilde;a</label>
                                                        <input type="text" class="form-control validate[required]" readonly="" name="subdominio" value="{$campania->subdominio}" placeholder="mi-producto.vikahotel.com">
                                                    </div>
                                                </div>
                                            ...
                                            <!--<div class="row-fluid">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control validate[required, custom[email]]" name="email" placeholder="reservas@ejemplo.com" value="{$campania->email}">
                                                    </div>
                                                </div>
                                                    <div class="delimiter"></div>
                                            </div>-->
                                            <div class="row-fluid">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="inicio" autocomplete="false" class="form-control validate[required]" {if $edit}value="{$campania->inicio|date_format:"%d-%m-%Y"}"{else}value="{date('d-m-Y')}"{/if}>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Fecha de finalización del contrato</label>
                                                        <input type="text" name="fin" autocomplete="false" class="form-control validate[required]" {if $edit}value="{$campania->fin|date_format:"%d-%m-%Y"}"{else}value="{date('d-m-')}{date('Y') + 1}"{/if}>
                                                    </div>
                                                </div>
                                                    <div class="delimiter"></div>
                                            </div>
                                            <div class="row-fluid tipo_hotel">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="">Estancia m&iacute;nima</label>
                                                            <select name="estanciaMinima" class="form-control">
                                                                {for $i=1 to 10}
                                                                    <option value="{$i}" {if $campania->estanciaMinima eq $i}selected{/if}>{$i} día{if $i>1}s{/if}</option>
                                                                {/for}
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="ventaAnticipada" class="form-control" placeholder="Release" >
                                                                {for $i=0 to 10}
                                                                    <option value="{$i}" {if $campania->ventaAnticipada eq $i}selected{/if}>{$i} día{if $i>1}s{/if}</option>
                                                                {/for}
                                                            </select>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 centered">
                                                <a href="#empresaDiv" class="btn btn-default ">Anterior</a>
                                    ...
                                    <!--<div id="promocionesDiv">
                                        ...
                                        <h3 class="form-section tipo_hotel">Promociones</h3>
                                        
                                        {if $campania->periodos}{assign var=periodo value=$campania->periodos[0]}{/if}

                                        <div class="row-fluid delimiter tipo_hotel" id="promociones">
                                            <div class="promocion">
                                                <div class="row-fluid">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="">Descuento respecto a booking.com</label>
                                                            <input type="text" name="promociones[XX][descuentoBooking]" class="form-control validate[required, custom[number]]" placeholder="Descuento" value="{if $periodo}{$periodo->descuentoBooking}{else}0{/if}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="">Tipo de descuento</label>
                                                            <select name="promociones[XX][tipoDescuento]" class="form-control">
                                                                <option value="%" {if $periodo->tipoDescuentoBooking eq '%'}selected{/if}>Porcentaje (%)</option>
                                                                <!--<option value="€" {if $periodo->tipoDescuentoBooking && $periodo->tipoDescuentoBooking ne '%'}selected{/if}>Euros (&euro;)</option>-->
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="promociones[XX][inicio]" class="form-control validate[required]" placeholder="Desde"  value="{if $periodo}{$periodo->inicio|date_format:"%d-%m-%Y"}{else}{date('d-m-Y')}{/if}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="">Hasta</label>
                                                            <input type="text" name="promociones[XX][fin]" class="form-control validate[required]" placeholder="Hasta" value="{if $periodo}{$periodo->fin|date_format:"%d-%m-%Y"}{else}{date('d-m-')}{date(Y) + 1}{/if}">
                                                        </div>
                                                    </div>
                                                    <div class="delimiter"></div>
                                                </div>
                                                <!--<div class="row-fluid">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="">Estancia m&iacute;nima</label>
                                                            <input type="text" name="promociones[XX][estanciaMinima]" class="form-control validate[required, custom[integer]]" placeholder="Estancia mínima" value="{$periodo->estanciaMinima}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="">Release</label>
                                                            <input type="text" name="promociones[XX][ventaAnticipada]" class="form-control validate[required, custom[integer]]" placeholder="Release" value="{$periodo->ventaAnticipada}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row-fluid ">
                                                        <div class="row-fluid">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="">Descuento respecto a booking.com</label>
                                                                    <input type="text" name="promociones[{$periodo->id}][descuentoBooking]" class="form-control validate[required, custom[number]]" placeholder="Descuento" value="{$periodo->descuentoBooking}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="">Tipo de descuento</label>
                                                                    <select name="promociones[{$periodo->id}][tipoDescuento]" class="form-control" >
                                                                        <option value="%" {if $periodo->tipoDescuento eq '%'}selected{/if}>Porcentaje (%)</option>
                                                                        <!--<option value="€" {if $periodo->tipoDescuento ne '%'}selected{/if}>Euros (&euro;)</option>-->
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="">Desde</label>
                                                                    <input type="text" name="promociones[{$periodo->id}][inicio]" class="form-control validate[required]" placeholder="Desde" value="{$periodo->inicio|date_format:"%d-%m-%Y"}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="">Hasta</label>
                                                                    <input type="text" name="promociones[{$periodo->id}][fin]" class="form-control validate[required]" placeholder="Hasta" value="{$periodo->fin|date_format:"%d-%m-%Y"}">
                                                                </div>
                                                            </div>
                                                            <div class="delimiter"></div>
                                                        </div>
                                            ...
                                            <div class="row-fluid ">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="">Tipo de descuento</label>
                                                            <select name="promociones[XX][tipoDescuento]" class="form-control" disabled="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 centered">
                                                <a href="#empresaDiv" class="btn btn-default ">Anterior</a>
                                                {if $usuario->usuarioGrupoId ne 3}
                                                    <a href="#finalizarDiv" class="btn btn-success ">Siguiente</a>
                                                {else}
                                    ...
                                    <div id="finalizarDiv">
                                        ...
                                        <h3 class="block">Verifica tus datos</h3>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Nº referencia:</label>
                                            <label class="col-md-4">{$campania->localizador}<input type="hidden" name="localizador" value="{$campania->localizador}"></label>
                                            <div class="delimiter"></div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <h4 class="form-section">Empresa</h3>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Distribuidor:</label>
                                            <label class="col-md-4" id="labelDistribuidora"></label>
                                            <div class="delimiter"></div>
                                        </div> 
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Cliente:</label>
                                            <label class="col-md-4" id="labelCliente"></label>
                                            <div class="delimiter"></div>
                                        </div>
                                        <h4 class="form-section">Producto</h3>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Nombre:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-4" id="labelInicio">{$campania->nombre}</label>
                                            <div class="delimiter"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Fin:</label>
                                            <label class="col-md-4" id="labelFin">{$campania->nombre}</label>
                                            <div class="delimiter"></div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-md-3">Estancia mínima:</label>
                                            <label id="labelEstanciaMinima" class="col-md-4 estancia-minima"></label>
                                            <div class="delimiter"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Release:</label>
                                            <label id="labelVentaAnticipada" class="col-md-4 venta-anticipada"></label>
                                            <div class="delimiter"></div>
                                        </div>
                                        ...
                                        <div class="periodo-resume hidden" id="periodo-resume">
                                            <label class="promo"></label>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Inicio:</label>
                                                <label class="col-md-4 inicio"></label>
                                                <div class="delimiter"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Fin:</label>
                                                <label class="col-md-4 fin"></label>
                                                <div class="delimiter"></div>
                                            </div>
                                            <div class="form-group">
...
<li>c) Asimismo, se obliga a ofrecer al Usuario de Internet y Comprador, la información adecuada para la reserva, entre ella, los precios y condiciones generales aplicables.</li>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label><label class="radio-inline"><input type="checkbox" value="1" class="atc validate[required]"></label> Acepto los T&eacute;rminos del contrato</label>
                                            </div>
                                        </div>
                                        
                                        <div class="row">
                                            <div class="col-md-12 centered ">
                                                <a class="btn btn-default" href="#contratoDiv" >Atras</a>
                                                <input type="submit" class="btn btn-success" value="Finalizar">
                                                {if $campania->id}
