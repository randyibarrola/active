...
{block name="script" append}
    <script type="text/javascript" src="{$template_url}/js/admin/empresa-lista.js"></script>
{/block}
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-user"></i>Empresas</div>
                        <div class="actions">
                            <a href="{$base_url}/admin-empresa-gestion{$end_url}" class="btn blue"><i class="fa fa-pencil"></i> Agregar</a>
                        </div>
                    </div>
