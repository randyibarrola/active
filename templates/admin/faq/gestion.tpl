                ...
                <div class="col-md-12" data-tablet="span12 fix-offset">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <div class="form-body">
                                <form action="#" class="horizontal-form" id="formulario">
                                    <div class="row row-hotel-content">
                                        ...
                                        <div class="row-fluid">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">FAQ's</label>
                                                    <div style="width: 100%;">
                                                        <textarea id="contenido" rows="6" class="ckeditor form-control"></textarea>
                                                        <textarea style="display:none;" name="contenido" >{$faq->contenido|replace:'&quot;':'\"'}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>                                       
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-center ">
                                            ...
                                            <a class="btn btn-default" href="{$base_url}/admin-reserva-lista" >Cancelar</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
