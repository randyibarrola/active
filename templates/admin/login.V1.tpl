...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">
		<img src="{$template_url}/images/logo.png" alt="" />
		<span>{#sistema_nombre#}</span>
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		...
		<form class="login-form" action="{$base_url}/admin-login" method="post">
			...
			<div class="form-group">
				...
				<div class="input-icon">
					...
					<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Correo electrónico" name="username"/>
				</div>
			</div>
			<div class="form-group">
			...
			<p>
				 No tienes una cuenta ?&nbsp; <a href="javascript:;" id="register-btn">Crear una cuenta</a>
			</p>
		</div>
		</form>
		<!-- END LOGIN FORM -->   
		<form class="register-form" action="index.html" method="post" novalidate="novalidate">
		<h3>Registra tu Hotel</h3>
		<p>
			 Datos básicos:
		</p>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Nombre del hotel</label>
			<div class="input-icon">
				<i class="fa fa-building-o"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Nombre del hotel" name="hotel_nombre">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" placeholder="Dirección" name="hotel_direccion">
			</div>
		</div>
                <div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Estancia mínima</label>
			<div class="input-icon">
				<i class="fa fa-clock-o"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Estancia mínima" name="hotel_estanciaMinima">
			</div>
		</div>
                <div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Release</label>
			<div class="input-icon">
				<i class="fa fa-clock-o"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Release" name="hotel_ventaAnticipada">
			</div>
		</div>
                <div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Descuento respecto a booking.com</label>
			<div class="input-icon">
				<i class="fa fa-money"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Descuento respecto a booking.com" name="hotel_descuentoBooking">
			</div>
		</div>
                <div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Tipo de descuento respecto a booking</label>
			<div class="input-icon">
				<i class="fa fa-money"></i>
				<select class="form-control placeholder-no-fix" placeholder="Tipo de descuento respecto a booking" name="hotel_tipoDescuentoBooking">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Nombre" name="empresa_contactoNombre">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Apellidos" name="empresa_contactoApellido">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" placeholder="Email" name="empresa_contactoEmail">
			</div>
		</div>
		<p>
			Empresa
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" placeholder="Nombre" name="empresa_nombre">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Dirección</label>
			<div class="input-icon">
				<i class="fa fa-location-arrow"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Dirección" name="empresa_direccion">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">País</label>
			<div class="select2-container select2 form-control" id="s2id_select2_sample4"><a href="javascript:void(0)" onclick="return false;" class="select2-choice select2-default" tabindex="-1">   <span class="select2-chosen"><i class="fa fa-map-marker"></i>&nbsp;Selecciona un país</span><abbr class="select2-search-choice-close"></abbr>   <span class="select2-arrow"><b></b></span></a><input class="select2-focusser select2-offscreen" type="text" id="s2id_autogen1"><div class="select2-drop select2-display-none select2-with-searchbox">   <div class="select2-search">       <input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" class="select2-input">   </div>   <ul class="select2-results">   </ul></div></div><select name="pais" id="select2_sample4" class="select2 form-control select2-offscreen" tabindex="-1">
				<option value=""></option>
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Fecha de inicio del contrato</label>
			<div class="input-icon">
				<i class="fa fa-clock-o"></i>
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Fecha de inicio del contrato" name="hotel_inicioContrato">
			</div>
		</div>
                <div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Fecha de finalización del contrato</label>
			<div class="input-icon">
				<i class="fa fa-clock-o"></i>
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Fecha de finalización del contrato" name="hotel_finContrato">
			</div>
		</div>
		<p>
			 Datos de tu cuenta:
		...
		<div class="form-group">
			<label>
			<div class="checker"><span><input type="checkbox" name="tnc"></span></div> I agree to the <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>
			</label>
