...
CREATE TABLE IF NOT EXISTS `vikahotel`.`evento` (
  ...
  INDEX `fk_evento_destino_turistico1_idx` (`destino_turistico_id` ASC),
  ...
  CONSTRAINT `fk_evento_campania1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_evento_destino_turistico1`
...
ALTER TABLE  `evento` CHANGE  `release`  `venta_anticipada` INT( 11 ) NULL DEFAULT NULL ;
ALTER TABLE  `campania` ADD  `tipo` VARCHAR( 30 ) NOT NULL ;
UPDATE campania SET `tipo` = "hotel"